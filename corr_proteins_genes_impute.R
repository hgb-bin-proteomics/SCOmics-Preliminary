...
data_imp <- missForest(data[,3:7], maxiter = 100, ntree = 1000, parallelize = "forests")
data[,3:7] <- data_imp$ximp
...
# impute
#registerDoParallel(cores = 5)
#data_imp_ngs <- missForest(data_ngs[,2:6], maxiter = 100, ntree = 1000, parallelize = "forests")
#data_ngs[,2:6] <- data_imp_ngs$ximp
